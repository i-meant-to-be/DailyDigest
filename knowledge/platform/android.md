...
## [AND-029] (실무) Android 앱에서 웹 URL 딥링크를 안전하게 받아 올바른 화면으로 연결하려면 어떻게 구성하나요?

> (미작성)

## [AND-030] (실무) Android에서 런타임 권한이 필요한 기능을 실행하려 할 때, 권한 상태 확인부터 요청·거부·재요청·설정 화면 안내까지 어떤 흐름으로 처리해야 하나요?
